...
public class Dashboard extends JFrame implements ActionListener{
	...
	String username;
	JButton addPersonalDetails, viewPersonalDetails, updatePersonalDetails, checkPackage, viewPackage, bookPackages, viewhotels, destinations;
...
//		setBounds(0, 0, 1600, 1000);
		...
		checkPackage.setMargin(new Insets(0, 0, 0, 95));
